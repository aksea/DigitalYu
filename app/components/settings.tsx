  ...
  return (
    <ErrorBoundary>
      ...
      <div className={styles["settings"]}>
        <List>
          <ListItem
            title={Locale.Settings.ParticipantName.Title}
            subTitle={Locale.Settings.ParticipantName.SubTitle}
          >
            <input
              aria-label={Locale.Settings.ParticipantName.Title}
              type="text"
              value={participantStore.name}
              placeholder={Locale.Settings.ParticipantName.Placeholder}
              onChange={(e) => participantStore.setName(e.currentTarget.value)}
            ></input>
          </ListItem>
